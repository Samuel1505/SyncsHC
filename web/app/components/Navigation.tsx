...
export default function Navigation() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-indigo-950/90 via-purple-950/90 to-cyan-950/90 backdrop-blur-xl border-b border-violet-500/20"
    >
